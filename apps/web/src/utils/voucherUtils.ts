 ...
 */
export const isVoucherExpired = (voucher: VoucherData): boolean => {
    const expiryStr = voucher.checkOut || voucher.expires_at;
 ...
 */
export const getVoucherExpirationDate = (voucher: VoucherData): Date | null => {
    const expiryStr = voucher.checkOut || voucher.expires_at;
